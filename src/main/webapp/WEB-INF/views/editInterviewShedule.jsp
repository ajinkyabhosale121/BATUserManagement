...
<%--                                     <div class="card-header">${hmessage}</div> --%>
                                    <div class="card-body">
                                        ...
                                        <hr>
                                       <form:form action="editInterviewShedule" method="post" novalidate="novalidate" modelAttribute="shedule">
                                       <form:input type="hidden" path="sheid" id="sheid"/>
                                       
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="request_id" class="control-label mb-1">Request:</label>
                                                
                                                <form:select path="request_id" class="form-control" style="color: #4272d7;">
								                
								                	<c:forEach items="${requests}" var="request">
								                	
							   							<form:option value="${request.getReqid()}" label="Language : ${request.getLanguage()} Experience : ${request.getYears_Of_Experience()} Vacancy : ${request.getVacancies()}"/>   							
							   						
							   						</c:forEach>
							   						
								                </form:select>
                                                <form:errors path="request_id" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="user_id" class="control-label mb-1">Interviewer:</label>
                                                
                                                  <form:select path="user_id" class="form-control" style="color: #4272d7;">
	                
									                	<c:forEach items="${users}" var="user">
									                	
								   							<form:option value="${user.getUserid()}" label="${user.getName()}"/>
								   						
								   						</c:forEach>
								   						
									            
									               </form:select>
                                                <form:errors path="user_id" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                             <div class="form-group">
                                                <label style="color: #00ad5f;" for="Name" class="control-label mb-1">Candidate Name:</label>
                                                 <form:input id="Name" path="Name" name="Name" class="form-control" style="color: #4272d7;"/>
                                                <form:errors path="Name" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Number" class="control-label mb-1">Candidate Number:</label>
                                                 <form:input id="Number" path="Number" name="Number" class="form-control" style="color: #4272d7;"/>
                                                <form:errors path="Number" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="EmailID" class="control-label mb-1">Candidate EmailID:</label>
                                                 <form:input id="EmailID" path="EmailID" name="EmailID" class="form-control" style="color: #4272d7;"/>
                                                <form:errors path="EmailID" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Address" class="control-label mb-1">Candidate Address:</label>
                                                 <form:textarea id="Address" path="Address" name="Address" class="form-control" rows="5" cols="50" style="color: #4272d7;"/>
                                                <form:errors path="Address" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Qualification_Id" class="control-label mb-1">Candidate Qualification:</label>
                                                  <form:select path="Qualification_Id" style="width: 300px; color: #4272d7;" class="form-control">
	                
									                	<c:forEach items="${qualifications}" var="qualification" >
									                	
								   							<form:option value="${qualification.getId()}" label="${qualification.getQualification()}"/>
								   						
								   						</c:forEach>
								   						
									                </form:select>
                                                <form:errors path="Qualification_Id" cssClass="error" style="color: red;"/>
                                            </div>
                                           
                                            <div class="form-group">
                                            	<fmt:formatDate pattern="yyyy-MM-dd'T'HH:mm" value="${shedule.interview_datetime}" var="datetimeString" />
                                                <label style="color: #00ad5f;" for="interview_datetime" class="control-label mb-1">Interview DateTime:</label>
                                                 <form:input type="datetime-local" value="${datetimeString}"  path="interview_datetime" id="interview_datetime" style="width: 300px;color: #4272d7;" class="form-control"/>
                                                <form:errors path="interview_datetime" cssClass="error" style="color: red;"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Result_Status_Id" class="control-label mb-1">Result Status:</label>
                                                  <form:select path="Result_Status_Id" style="width: 300px;color: #4272d7;" class="form-control">
	                
								                	<c:forEach items="${rStatuses}" var="rStatuse">
									                	
					   									<form:option value="${rStatuse.getId()}" label="${rStatuse.getStatus()}"/>
								   						
								   					</c:forEach>
								   						
									                </form:select>
                                                <form:errors path="Result_Status_Id" cssClass="error" style="color: red;"/>
                                            </div>
	...
	function notifyRe(message){
	    ...
	    window.location.href = url + "/viewInterviewShedule";
	}
