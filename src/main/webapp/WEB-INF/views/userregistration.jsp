...
<%--                                     <div class="card-header">${hmessage}</div> --%>
                                    <div class="card-body">
                                        ...
                                        <hr>
                                       <form:form id="userRegForm" action="userregistration" method="post" novalidate="novalidate" modelAttribute="user">
                                       <form:input type="hidden" path="userid" id="userid"/>
                                            <div class="form-group">
                                                <label for="Name" class="control-label mb-1" style="color: #00ad5f;">Name:</label>
                                                <form:input style="color: #4272d7;" id="Name" path="Name" name="Name" type="text" class="form-control" size="50"/>
                                                <form:errors path="Name" cssClass="error" style="color: red;"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="Number" class="control-label mb-1" style="color: #00ad5f;">Number:</label>
                                                 <form:input style="color: #4272d7;" id="Number" path="Number" name="Number" type="text" class="form-control" size="50"/>
                                                <form:errors path="Number" cssClass="error" style="color: red;"/>
                                            </div>
                                             <div class="form-group">
                                                <label for="Address" class="control-label mb-1" style="color: #00ad5f;">Address:</label>
                                                 <form:textarea style="color: #4272d7;" id="Address" path="Address" name="Address" type="text" class="form-control" rows="5" cols="50"/>
                                                <form:errors path="Address" cssClass="error" style="color: red;"/>
                                            </div>
                                             <div class="form-group">
                                                <label for="EmailID" class="control-label mb-1" style="color: #00ad5f;">EmailID:</label>
                                                 <form:input style="color: #4272d7;" id="EmailID" path="EmailID" name="EmailID" type="email" class="form-control"/>
                                                <form:errors path="EmailID" cssClass="error" style="color: red;"/>
                                            </div>
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Qualification_ID" class="control-label mb-1">Qualification:</label>
                                                  <form:select path="Qualification_ID" class="form-control" style="color: #4272d7;">
                                            ...
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Designation" class="control-label mb-1">Designation:</label>
                                                 <form:input style="color: #4272d7;" id="Designation" path="Designation" name="Designation" type="text" class="form-control"/>
                                                <form:errors path="Designation" cssClass="error" style="color: red;"/>
                                            </div>
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Username" class="control-label mb-1">Username:</label>
                                                 <form:input style="color: #4272d7;" id="Username" path="Username" name="Username" type="text" class="form-control"/>
                                                <form:errors path="Username" cssClass="error" style="color: red;"/>
                                            </div>
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="Password" class="control-label mb-1">Password:</label>
                                                 <form:input style="color: #4272d7;" id="Password" path="Password" name="Password" type="password" class="form-control"/>
                                                <form:errors path="Password" cssClass="error" style="color: red;"/>
                                            </div>
                                            <div class="form-group">
                                                <label style="color: #00ad5f;" for="role_id" class="control-label mb-1">Role:</label>
                                                 
                                                  <form:select path="role_id" class="form-control" style="color: #4272d7;">
	                
									                	<c:forEach items="${roles}" var="role">
									                	
								   							<form:option value="${role.getId()}" label="${role.getRole()}"/>
								   							
								   						</c:forEach>
								   						
									                </form:select>
                                                 
                                                <form:errors path="role_id" cssClass="error" style="color: red;"/>
                                            </div>
                                             <c:choose>
							                        <c:when test="${edit}">
